...
public class VideoItem extends FilmstripItemBase<VideoItemData> {
    ...
    public void renderThumbnail(@Nonnull View view) {
        mGlideManager.loadScreen(mData.getUri(), generateSignature(mData), mSuggestedSize, mData.getOrientation(), mData.getFormat())
              .thumbnail(mGlideManager.loadMediaStoreThumb(mData.getUri(),
                    generateSignature(mData), mData.getOrientation(), mData.getFormat()))
    ...
    private void renderTiny(@Nonnull VideoViewHolder viewHolder) {
        mGlideManager.loadMediaStoreThumb(mData.getUri(), generateSignature(mData), mData.getOrientation(), mData.getFormat())
