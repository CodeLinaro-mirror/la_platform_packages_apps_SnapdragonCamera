...
public class Basic2d {
    ...
    private float mScaleX, mScaleY = 1.0f;
    ...
    public Basic2d(BasicDrawable drawable) {
        mDrawable = drawable;
        mColor = new float[4];
        mColor[3] = 1.0f;
        mTextureId = -1;
     ...
     * Draws the rectangle with the supplied program and projection matrix.
     */
/*    public void draw(TextureProgram program, float[] projectionMatrix) {
        // Compute model/view/projection matrix.
        Matrix.multiplyMM(mScratchMatrix, 0, projectionMatrix, 0, getModelViewMatrix(), 0);
    ...
    public String toString() {
        return "[Basic2d pos=" + mPosX + "," + mPosY +
