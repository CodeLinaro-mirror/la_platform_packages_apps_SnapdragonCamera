...
public class BasicDrawable {
    ...
    private static final float FULL_RECTANGLE_TEX_COORDS_2[] = {
            0.0f, 0.0f,     // 0 bottom left
            1.0f, 0.0f,     // 1 bottom right
            1.0f, 1.0f,      // 3 top right
            0.0f, 1.0f,     // 2 top left
    ...
    private static final FloatBuffer FULL_RECTANGLE_BUF_2 =
            GLUtil.createFloatBuffer(FULL_RECTANGLE_COORDS_2);
    private static final FloatBuffer FULL_RECTANGLE_TEX_BUF_2 =
            GLUtil.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS_2);
     ...
     */
    public enum SHAPE {
        TRIANGLE, RECTANGLE, FULL_RECTANGLE, BASIC_RECTANGLE
    }
     ...
     */
    public BasicDrawable(SHAPE shape) {
        switch (shape) {
            case TRIANGLE:
            ...
            case BASIC_RECTANGLE:
                mVertexArray = FULL_RECTANGLE_BUF_2;
                mTexCoordArray = FULL_RECTANGLE_TEX_BUF_2;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = FULL_RECTANGLE_COORDS_2.length / mCoordsPerVertex;
                break;
            default:
    ...
    public void setTexCoordArray(FloatBuffer texCoordArray) {
        mTexCoordArray = texCoordArray;
    }

    @Override
    public String toString() {
        if (mShape != null) {
            return "[BasicDrawable: " + mShape + "]";
        } else {
