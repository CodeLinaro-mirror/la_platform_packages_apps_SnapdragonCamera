...
ifneq (,$(TARGET_BUILD_APPS))
  LOCAL_JNI_SHARED_LIBRARIES := libjni_mfnrutil libjni_aidenoiserutilv2 libjni_imageutil
else
  LOCAL_REQUIRED_MODULES := libjni_mfnrutil libjni_aidenoiserutilv2 libjni_imageutil
endif
